    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            @if (check_user_permissions(request(), 'Users@index'))
                <li
                    class="sidebar-item {{ request()->route()->getName() == 'backend.users.index' ||request()->route()->getName() == 'backend.users.edit' ||request()->route()->getName() == 'backend.users.create'? 'active-yellow': '' }}">
            ...
            @if (check_user_permissions(request(), 'Categorias@index'))
                <li
                    class="sidebar-item {{ request()->route()->getName() == 'backend.categorias.index' ||request()->route()->getName() == 'backend.categorias.edit' ||request()->route()->getName() == 'backend.categorias.create'? 'active-yellow': '' }}">
            ...
            @if (check_user_permissions(request(), 'Expedientes@index'))
                <li
                    class="sidebar-item {{ request()->route()->getName() == 'backend.horario-expediente.index' ||request()->route()->getName() == 'backend.horario-expediente.index' ||request()->route()->getName() == 'backend.horario-expediente.index'? 'active-yellow': '' }}">
                    <a class="sidebar-link" href="{{ route('backend.horario-expediente.index') }}">
                        <i class="align-middle" data-feather="clock"></i> <span class="align-middle">Horário de
                            Expediente</span>
                    </a>
                </li>
            @endif
            ...
            @if (check_user_permissions(request(), 'Blog@index'))
                <li
                    class="sidebar-item {{ request()->route()->getName() == 'backend.blog.index' ||request()->route()->getName() == 'backend.blog.edit' ||request()->route()->getName() == 'backend.blog.create' ||request()->route()->getName() == 'backend.blog.show' ||request()->route()->getName() == 'backend.blog.comment'? 'active-yellow': '' }}">
            ...
            @if (check_user_permissions(request(), 'Files@index'))
                <li
                    class="sidebar-item {{ request()->route()->getName() == 'backend.multimedias.index' ||request()->route()->getName() == 'backend.multimedias.create' ||request()->route()->getName() == 'backend.multimedias.edit'? 'active-yellow': '' }}">
