...
<body>
    ...
    <header class="fixed-top">
        <div id="topo-header" class="bg-amarelo m-0 ">
            ...
            <form action="resultado-pesquisa.html" id="formulario-topo"
                class="form-inline d-inline-block  p-0 col-5 col-md-6">

                <input class="form-control p-1" type="search" placeholder="Pesquisar na CIVAL..."
                    aria-label="Pesquisar">
                <button class=" btn btn-preto" type="submit">
                    <i class="bi-search text-amarelo"></i>
                </button>
        ...
        <div id="header" class="container-fluid px-4 d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="index.html#services">Películas</a></li>
                    <li><a class="nav-link scrollto" href="index.html#services">Matrículas</a></li>
                    <li><a class="nav-link scrollto" href="index.html#services">Inspenção</a></li>
