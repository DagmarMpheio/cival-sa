            ...
            <div class="col-md-4 col-xl-3">
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <img src="backend/img/avatars/avatar-4.jpg" alt="Christina Mason" class="img-fluid rounded-circle mb-2"
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-1"><span data-feather="briefcase" class="feather-sm me-1"></span> Trabalha no(a) <a
                                    href="#">GitHub</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body h-100">
                        ...
                        <div class="d-flex align-items-start">
                            <img src="backend/img/avatars/avatar-5.jpg" width="36" height="36" class="rounded-circle me-2"
                                alt="Vanessa Tucker">
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="backend/img/avatars/avatar.jpg" width="36" height="36" class="rounded-circle me-2"
                                alt="Charles Hall">
                            <div class="flex-grow-1">
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="backend/img/avatars/avatar-4.jpg" width="36" height="36"
                        ...
                        <hr />
                        <div class="d-flex align-items-start">
                            <img src="backend/img/avatars/avatar-2.jpg" width="36" height="36"
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="row g-0 mt-1">
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img src="backend/img/photos/unsplash-1.jpg" class="img-fluid pe-2" alt="Unsplash">
                                    </div>
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <img src="backend/img/photos/unsplash-2.jpg" class="img-fluid pe-2" alt="Unsplash">
                                    </div>
                                </div>
