 @foreach ($multimedias as $multimedia)
     ...
     <div class="col-12 col-md-4">
         <div class="card">
             <audio src="/multimedia/uploadAudio/{{ $multimedia->ficheiro }}" controls="controls" width="300"
                 height="200">
             </audio>
             ...
             <div class="card-body">
                 ...
                 <div class="row">
                      <div class="col-md-6 text-start">
                         <a href="/multimedia/uploadAudio/{{ $multimedia->ficheiro }}" class="card-link text-yellow1"
